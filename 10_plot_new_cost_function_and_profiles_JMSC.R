...
source("~/code/6_GSA_stochastic_article/scripts/0_open_c_alpha_A_multidx_marginals_MM.R")
...
metamodel_directory <- "~/Documents/Cours_presentations_formations/4_Presentation_poster_article/2_Conferences/JMSC_strasbourg_2024/scripts_PCE/metamodels/"

## Load peshmelba simulations under the new cost function
...
#idx_of_conditional_minimizer <- 48 #c(15,82,113,122) 
...
true_rain_idx <- 53
y_true <- npyLoad("Ymoisture_profile_LHS25_100_R500_dim6_YzeronS06_LogN.npy")[true_rain_idx*100+1,] 
...
ggarrange(new_cost_function, new_profiles, ncol=2, nrow=1, common.legend = TRUE, legend="bottom")
...
dev.off()
tools::texi2dvi('new_profiles_and_costfct.tex',pdf=T) ## LUALATEX
