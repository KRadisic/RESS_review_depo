...
###     READ THE TEST C_ALPHA
###     CALCULATE GLOBAL QUALITY OF MARGINAL DISTRIBUTION
...
for (n_pc in c(2))
{
  ...
  #save(df_eps_marg_train_bootstrap, file = paste('df_eps_marg_train_PC',n_pc,'_marg_bootstrap_beta',str_beta,'.RData', sep=""))
}
